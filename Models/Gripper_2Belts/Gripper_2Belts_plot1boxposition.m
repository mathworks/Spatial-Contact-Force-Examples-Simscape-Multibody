...
simlog_t = simlog_Gripper_2Belts.Box_Joint.Px.p.series.time;
simlog_boxPx = simlog_Gripper_2Belts.Box_Joint.Px.p.series.values('m');
simlog_boxPy = simlog_Gripper_2Belts.Box_Joint.Py.p.series.values('m');
simlog_boxPz = simlog_Gripper_2Belts.Box_Joint.Pz.p.series.values('m');
...
text(0.05,0.05,[sprintf('%3.2f', Elapsed_Sim_Time) ' sec, ' num2str(length(tout)) ' Steps'],'Units','normalized','Color',[0.6 0.6 0.6])
